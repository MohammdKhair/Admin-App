...
import 'package:admin_app/screens/categories/categories_edit/controller/categories_edit_contoller.dart';
...
class CategoriesEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CategoriesEditControllerImp>(builder: (controller) {
